...
if (isset($_GET['id'])) {
    ...
    $sqlEdit = "SELECT * FROM fichas WHERE id_ficha = '$id_ficha' and usuario = '$usuario'";
...
if (isset($_GET['tema'])) {
        ...
        header("Location: editarFicha.php?id=".urlencode($id_ficha));
    }
?>
...
<body>
            ...
            <ul class="opcoesSidebar">
                ...
                <a>
                    ...
                    <ul class="listaFichasSidebar" id="listaFichasSidebar2">
                        <a href="editarFicha.php?id=<?php print_r($id_ficha) ?>&tema=escuro">
                            <li class="<?php print_r($rowtema['tema'] == 'escuro' ? 'ativo' : ''); ?>">
                                <i class="bi bi-moon"> Modo escuro</i>
                            </li>
                        </a>
                        <a href="editarFicha.php?id=<?php print_r($id_ficha) ?>&tema=claro">
    ...
    <form action="php/dadosFicha.php" method="post" enctype="multipart/form-data">
        <header>
            <div class="cab">
